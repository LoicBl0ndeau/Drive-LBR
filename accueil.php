...
<html lang="fr">
  ...
  <body>
		<?php
			echo "<script> sessionStorage.setItem('role','".$_SESSION['loggedUser']['Role']."');</script>";// on récupèrele role de la personne connecter pour l'envoyer au fichier JS afin de gerer les restriction si la personne n'est pas admin
		?>
